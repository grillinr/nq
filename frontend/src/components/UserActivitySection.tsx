...
import { fontSize, fontWeights, lineHeight, radii, spacing, ColorPalette } from './ui/tokens';
...
export function UserActivitySection({ activity, onUpdate }: UserActivitySectionProps) {
  ...
  if (!activity) {
    return (
      <View style={[styles.container, { backgroundColor: colors.background }]}>
        <Text style={styles.emptyText}>Track this item to add a rating and review</Text>
      </View>
    );
  }
      ...
      {hasRatingOrReview ? (
        <>
          ...
          <View style={styles.statusBadge}>
            <Text style={styles.statusText}>Status: {activity.status.name}</Text>
          </View>
        </>
      ) : (
        <View style={styles.section}>
          <Text style={styles.emptyText}>No rating or review yet</Text>
